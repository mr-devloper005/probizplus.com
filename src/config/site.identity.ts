export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'probizplus',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Probizplus',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'probizplus.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://probizplus.com',
